...
tracked_emails_index_seq = Sequence('tracked_emails_index_seq', optional=True)

class TrackedEmail(Base):
    __tablename__ = "tracked_emails"

    index = Column(Integer, tracked_emails_index_seq, server_default=FetchedValue(), unique=True, nullable=True)
